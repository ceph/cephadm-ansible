...
import pytest
from . import common
from ansible_collections.ceph.orchestration.plugins.modules import ceph_orch_host


class TestCephOrchHost(object):

    @patch('ansible_collections.ceph.orchestration.plugins.modules.ceph_orch_host.get_current_state')
